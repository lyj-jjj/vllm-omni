...
class OmniServeCommand(CLISubcommand):
    ...
    def subparser_init(self, subparsers: argparse._SubParsersAction) -> FlexibleArgumentParser:
        ...
        omni_config_group.add_argument(
            ...
            type=str,
            default=None,
            help="Config-level KV-cache quantization skip-step selector, format like '0-9,20,25-30'.",
        )
        omni_config_group.add_argument(
            "--kv-cache-skip-layers",
            type=str,
            default=None,
            help="Config-level KV-cache quantization skip-layer selector, format like '0,1,4-8'.",
        )
        omni_config_group.add_argument(
            "--cfg-parallel-size",
            type=int,
