...
from vllm_omni.diffusion.attention.backends.abstract import AttentionMetadata, _update_attn_metadata
...
class WanTransformerBlock(nn.Module):
    ...
    def forward(
        ...
        self_attn_metadata = _update_attn_metadata(
            base_attn_metadata,
            layer_idx=layer_idx,
            attn_kind="self",
        ...
        cross_attn_metadata = _update_attn_metadata(
            base_attn_metadata,
            layer_idx=layer_idx,
            attn_kind="cross",
            attn_mask=None,
